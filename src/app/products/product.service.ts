...
export class ProductService {
  ...
  // exposes the readonly observable from our subject 
  ...
  getProducts(): Observable<IProduct[]> {
    if(this.products.length > 0){
      ...
      // of operator creates an observable from te provided array
    }
    return this.http.get<IProduct[]>(this.productsUrl)
      .pipe(
        tap(data => console.log(JSON.stringify(data))), // taps into the stream of observable and allows to take some action before it is emitted
